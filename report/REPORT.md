...
|---|---|---|
| `max_abs_err` | **7.093e-06** | 2.265e-06 |
| `mean_abs_err` | 2.031e-06 | 4.108e-07 |
| `top1_identical` | **True**（32/32） | **True**（32/32） |
| Top-5 最小重合 | 5 / 5 | 5 / 5 |
| BN 模块数 | **108 → 0** | 108 → 0 |
| 参数量 | 4,732,805 → 4,696,301（净减 **36,504**） | 5,489,328 → 5,067,056（净减 422,272） |
| ONNX 节点 | BatchNormalization **0**、Conv **103**（未融合 126，少 23） | 同上 |
