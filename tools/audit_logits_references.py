...
BUCKETS = {
    ...
    'B2_onnx_m0_9_in1k_n12': dict(
        title='PyTorch↔ONNX｜M0.9 官方 ImageNetV2 子集｜n=12 张真实图片',
        authority='outputs/metrics/consistency_repvit_m0_9_in1k.json',
        display='max 1.383e-05 / mean 2.334e-06',
        repro='yes',
        cmd='python deploy/compare_torch_onnx.py --model repvit_m0_9_in1k --images datasets/lists/imagenetv2_mf_1000.txt --limit 12 --out outputs/verification/consistency_repvit_m0_9_in1k_n12.json',
    ),
    'B3_onnx_m1_0_in1k_n12': dict(
        title='PyTorch↔ONNX｜M1.0 官方 ImageNetV2 子集｜n=12 张真实图片',
        authority='outputs/metrics/consistency_repvit_m1_0_in1k.json',
        display='max 1.335e-05 / mean 2.215e-06',
        repro='yes',
        cmd='python deploy/compare_torch_onnx.py --model repvit_m1_0_in1k --images datasets/lists/imagenetv2_mf_1000.txt --limit 12 --out outputs/verification/consistency_repvit_m1_0_in1k_n12.json',
    ),
    'B12_onnx_m1_1_in1k_n12': dict(
        title='PyTorch↔ONNX｜M1.1 官方 ImageNetV2 子集｜n=12 张真实图片',
        authority='outputs/metrics/consistency_repvit_m1_1_in1k.json',
        display='max 1.860e-05 / mean 2.219e-06',
        repro='yes',
        cmd='python deploy/compare_torch_onnx.py --model repvit_m1_1_in1k --images datasets/lists/imagenetv2_mf_1000.txt --limit 12 --out outputs/verification/consistency_repvit_m1_1_in1k_n12.json',
    ),
    'B13_onnx_m1_5_in1k_n12': dict(
        title='PyTorch↔ONNX｜M1.5 官方 ImageNetV2 子集｜n=12 张真实图片',
        authority='outputs/metrics/consistency_repvit_m1_5_in1k.json',
        display='max 1.144e-05 / mean 1.876e-06',
        repro='yes',
        cmd='python deploy/compare_torch_onnx.py --model repvit_m1_5_in1k --images datasets/lists/imagenetv2_mf_1000.txt --limit 12 --out outputs/verification/consistency_repvit_m1_5_in1k_n12.json',
    ),
...
PATH_RULES = [
    ...
    ('outputs/verification/consistency_repvit_m0_9_in1k_n12.json', 'B2_onnx_m0_9_in1k_n12'),
    ('outputs/metrics/consistency_repvit_m1_0_in1k.json', 'B3_onnx_m1_0_in1k_n12'),
    ('outputs/verification/consistency_repvit_m1_0_in1k_n12.json', 'B3_onnx_m1_0_in1k_n12'),
    ('outputs/metrics/consistency_repvit_m1_1_in1k.json', 'B12_onnx_m1_1_in1k_n12'),
    ('outputs/verification/consistency_repvit_m1_1_in1k_n12.json', 'B12_onnx_m1_1_in1k_n12'),
    ('outputs/metrics/consistency_repvit_m1_5_in1k.json', 'B13_onnx_m1_5_in1k_n12'),
    ('outputs/verification/consistency_repvit_m1_5_in1k_n12.json', 'B13_onnx_m1_5_in1k_n12'),
